                ...
                <div class="panel">
                  ...
                  <div class="col-md-12 padding-0" style="padding-bottom:20px;">
                    ...
                    <p class="narrow text-center">
                      ...
                      <tbody>
                       <?php 
                        $pesan = mysqli_query($koneksi,"SELECT * FROM pesanan ORDER BY tanggal ASC");
                        ...
                        <tr>
                          ...
                          <td>
                             ...
                             if($pesanan['status'] == "Belum Lunas"){?>
                                 <a href="transaksi.php?id=<?php echo $pesanan['id_pesanan']; ?>" class="btn btn-sm btn-primary">Aksi</a>
                             <?php }else{
                                 
                             }
                            ?>
                              <a href="delete-transaksi.php?id=<?php echo $pesanan['id_pesanan']; ?>" class="btn btn-sm btn-danger">Delete</a></td>
                        </tr>
                    <?php } ?>
                      </tbody>
                        </table>
