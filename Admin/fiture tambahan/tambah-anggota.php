                        ...
                        <form class="cmxform" id="signupForm" method="POST" action="">
                          <div class="col-md-6">
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" id="nomor_anggota" name="nomor_anggota" required>
                              <span class="bar"></span>
                              <label>Nomor Anggota</label>
                            </div>

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" id="no_identitas" name="no_identitas" required>
                              <span class="bar"></span>
                              <label>No.Identitas</label>
                            </div>

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" id="validate_username" name="nama_anggota" required>
                              <span class="bar"></span>
                          ...
                          <div class="col-md-6">
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="tezt" class="form-text" id="nomor_anggota" name="tempat_lahir" required>
                              <span class="bar"></span>
                            ...
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" id="nomor_anggota" name="alamat" required>
                              <span class="bar"></span>
                              <label>Alamat</label>
                            </div>
                             <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" id="nomor_anggota" name="no_hp" required>
                              <span class="bar"></span>
