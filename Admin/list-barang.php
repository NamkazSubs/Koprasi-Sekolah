                  ...
                  <div class="col-md-12 padding-0" style="padding-bottom:20px;">
                    ...
                    while ($ahay = mysqli_fetch_array($jijo)){?>
                        <tr>
                          ...
                          <td><?php echo $ahay['nama_barang']; ?></td>
                          <td><?php echo "Rp ".number_format((double)$ahay['harga'],0,',','.').""; ?></td>
                          <td><?php echo $ahay['stok']; ?></td>
                          <td><a href="edit-barang.php?id=<?php echo $ahay['id_barang']; ?>" class="btn btn-sm btn-danger">Edit</a>
                              <a href="delete-barang.php?kode=<?php echo $ahay['id_barang']; ?>" class="btn btn-sm btn-danger">Delete</a></td>
                        </tr>
                    <?php $nomor++ ?>
                    <?php } ?>
                      </tbody>
