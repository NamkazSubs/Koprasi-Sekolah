                ...
                <div class="col-md-12">
                  <div class="col-md-12 panel">
                    ...
                    <div class="col-md-12 panel-body" style="padding-bottom:30px;">
                      <div class="col-md-12">
                        <form class="cmxform" id="signupForm" method="POST" action="proses/proses-aksi.php">
                          <div class="col-md-12">
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" id="nama_barang" name="nama_barang" value="<?php echo $data_barang['nama_barang']; ?>" required>
                              <span class="bar"></span>
                              <label>Nama Barang</label>
                            </div>

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" id="harga" name="harga" value="<?php echo $data_barang['harga']; ?>" required>
                              <span class="bar"></span>
                              <label>Harga Barang</label>
                            </div>
                            
                             <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="number" class="form-text" id="stok" name="stok" min="0" max="99999999999" step="1" value="<?php echo $data_barang['stok']; ?>" required>
                              <span class="bar"></span>
